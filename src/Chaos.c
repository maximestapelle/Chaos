...
sqlite3 * database;
//Map
int rowid = 0;									 /* The entry in the database if the request was already made in the past */
...
char variablesNames[DIMENSION_MAX][15]; 			 /* Whatever the dimension, we will store the variable LaTeX names as a R^3 vector. Subsequent
														programs will ignore non-existing dimensions.*/
char parametersNames[NUMBER_PARAMETERS_MAX][15];   	 /* Whatever the number of parameters, we will store the parameters LaTeX names as a NParamMax
